  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300 overflow-x-hidden">
      <Helmet>
        ...
        <meta name="keywords" content="physiotherapy, physical therapy, sports injuries, rehabilitation, Dr. Malak Tamer, علاج طبيعي, تأهيل إصابات" />
      ...
      <main className="relative">
        <TracingBeam>
          ...
          <LampContainer className="py-20 min-h-[600px] w-full bg-transparent">
            <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 w-full">
