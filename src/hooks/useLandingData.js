...
const DEFAULT_DATA = {
  ...
  about: {
    contentEn: "Dr. Malak Tamer is a highly skilled physiotherapist specializing in sports injuries and rehabilitation. With years of experience, she has helped hundreds of patients regain their mobility.",
    contentAr: "د. ملك تامر هي أخصائية علاج طبيعي ماهرة متخصصة في الإصابات الرياضية والتأهيل. مع سنوات من الخبرة، ساعدت مئات المرضى على استعادة حركتهم.",
    contentTr: "Dr. Malak Tamer, spor yaralanmaları ve rehabilitasyon konusunda uzmanlaşmış oldukça yetenekli bir fizyoterapisttir. Yılların deneyimiyle yüzlerce hastanın hareket kabiliyetini geri kazanmasına yardımcı olmuştur.",
  },
  certificates: [
  ...
  contact: {
    email: "dr.malak.tamer@example.com",
    phone: "",
  }
};
