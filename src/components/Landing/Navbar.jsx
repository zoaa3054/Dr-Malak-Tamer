...
const Navbar = () => {
  ...
  return (
    <nav className={cn(
      ...
      scrolled ? "glass py-2" : "bg-transparent border-transparent py-4"
    )}>
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <a href="#hero" className="text-2xl text-primary hover:opacity-80 transition-opacity" style={{ fontFamily: "'Dancing Script', cursive" }}>
                  ...
                  {languages.map((lang) => (
                    <button
                      ...
                      className={cn(
                        ...
                        currentLang === lang.code && "text-primary font-bold bg-primary/5"
                      )}
                    >
                      {lang.label}
