        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              Have a question or want to book a session? {t('common.doctor_name')} is here to help you on your journey to recovery.
            </p>
          ...
          <motion.form
            ...
            className="glass premium-shadow p-8 rounded-3xl space-y-4"
          >
            <div className="space-y-4">
...
const ContactInfo = ({ icon, label, value }) => {
  ...
  return (
    <motion.div
      whileHover={{ x: 5 }}
      className="flex items-center gap-4 p-4 glass premium-shadow rounded-2xl transition-all group"
    >
